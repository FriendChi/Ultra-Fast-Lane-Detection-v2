from utils.loss import SoftmaxFocalLoss, ParsingRelationLoss, ParsingRelationDis, MeanLoss, TokenSegLoss, VarLoss, EMDLoss, RegLoss,LabelSmoothingCrossEntropyLoss
...
def get_loss_dict(cfg):
    if cfg.dataset == 'CurveLanes':
        ...
        loss_dict = {
            ...
            'op': [SoftmaxFocalLoss(2, ignore_lb=-1), ParsingRelationLoss(), ParsingRelationDis(), SoftmaxFocalLoss(2, ignore_lb=-1), LabelSmoothingCrossEntropyLoss(),  LabelSmoothingCrossEntropyLoss(), MeanLoss(), MeanLoss(),],
