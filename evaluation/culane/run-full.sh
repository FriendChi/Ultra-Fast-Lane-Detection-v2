...
im_h=590
frame=1
list0=/kaggle/working/temp/list/list/test_split/test0_normal.txt
list1=/kaggle/working/temp/list/list/test_split/test1_crowd.txt
list2=/kaggle/working/temp/list/list/test_split/test2_hlight.txt
list3=/kaggle/working/temp/list/list/test_split/test3_shadow.txt
list4=/kaggle/working/temp/list/list/test_split/test4_noline.txt
list5=/kaggle/working/temp/list/list/test_split/test5_arrow.txt
list6=/kaggle/working/temp/list/list/test_split/test6_curve.txt
list7=/kaggle/working/temp/list/list/test_split/test7_cross.txt
list8=/kaggle/working/temp/list/list/test_split/test8_night.txt
