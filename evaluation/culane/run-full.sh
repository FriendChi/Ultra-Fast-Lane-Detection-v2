...
im_h=590
frame=1
list0=${data_dir}list/list/test_split/test0_normal.txt
list1=${data_dir}list/list/test_split/test1_crowd.txt
list2=${data_dir}list/list/test_split/test2_hlight.txt
list3=${data_dir}list/list/test_split/test3_shadow.txt
list4=${data_dir}list/list/test_split/test4_noline.txt
list5=${data_dir}list/list/test_split/test5_arrow.txt
list6=${data_dir}list/list/test_split/test6_curve.txt
list7=${data_dir}list/list/test_split/test7_cross.txt
list8=${data_dir}list/list/test_split/test8_night.txt
