...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.coordatt = C3CA(planes, planes)
...
def resnet18_ca(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # 遍历预训练权重字典
        pretrained_state_dict = {k: v for k, v in pretrained_state_dict.items() if k in now_state_dict and v.size() == now_state_dict[k].size()}
